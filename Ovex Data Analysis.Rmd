...
avg_clr_after_taxa_analysis = ggpubr::ggarrange(lacto_2_top, Riken_another, s247_f44, ncol = 1,nrow=3,labels = c("A", "B", "C"))

ggsave(filename = "Other_3_clr_abund.svg", plot = avg_clr_after_taxa_analysis)
